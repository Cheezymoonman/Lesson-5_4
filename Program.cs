...
namespace Lesson_5_4_Lab
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Mario is running through the level and meets a Goomba. Set Mario to jumping so he can kill it");
            mario.isJumping = true;

            Console.WriteLine("Mario Squashes the Goomba. Now he needs to land!");
            mario.isJumping = false;
